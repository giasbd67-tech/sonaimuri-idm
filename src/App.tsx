...
export default function App() {
  ...
  const getAbsentMsg = (st: any) => `আসসালামু আলাইকুম, আজ আপনার সন্তান ${st.name} (শ্রেণী: ${st.class_name}) মাদরাসায় উপস্থিত নেই। অনুপস্থিতির সঠিক কারণটি জানানোর জন্য অনুরোধ করা হলো। অনুরোধক্রমে, সোনাইমুড়ী ইসলামিয়া দাখিল মাদরাসা।`;
      ...
      <div className="min-h-screen bg-slate-100 flex items-center justify-center p-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white p-8 rounded-[3rem] shadow-2xl w-full max-w-md border border-white">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-[10px] font-black uppercase tracking-widest mt-1">সোনাইমুড়ী ইসলামিয়া দাখিল মাদরাসা</p>
          </div>
